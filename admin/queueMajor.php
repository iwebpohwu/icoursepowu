...
<head>
    ...
    <title>院科管理 >> 專業列表</title>
</head>
<body>
<h3 class="subtitle">院科管理 >> 專業查詢</h3>
<form action="./fun/getMajor.php" method="get" target="resultbox">
     <div class="twocols inputbox"><span>院科：</span>
    <?php
    ...
    <a style="float:left" href="./fun/addMajor.php" target="resultbox">新增專業</a>
